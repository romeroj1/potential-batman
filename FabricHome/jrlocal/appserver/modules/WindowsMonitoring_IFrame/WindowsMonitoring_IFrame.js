...
Splunk.Module.WindowsMonitoring_IFrame = $.klass(Splunk.Module.IFrameInclude, {
    ...
    onLoad: function(event) {
        this.logger.info("WindowsMonitoring_IFrame onLoad event fired.");
    ...
    resize: function() {
        this.logger.info("WindowsMonitoring_IFrame resize fired.");
